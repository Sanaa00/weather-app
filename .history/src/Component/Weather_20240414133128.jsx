  ...
  return (
    <div className='flex justify-between items-center bg-slate-100 w-2/4 h-3/4 rounded-sm shadow p-5'>
      <div className='flex flex-col justify-center items-center w-1/3 bg-gradient-to-br from-cyan-500 to-sky-500 h-full rounded'>
        ...
        <div className='flex flex-col justify-center items-center mt-10 text-slate-100'>
          <p>Today</p>
          <p>City name</p>
        </div>{' '}
        <div className='flex flex-col justify-center items-center mt-10 text-slate-100 font-medium'>
          <p>Humidity: 30</p>
          <p>wind:20</p>
        </div>
      </div>
