...
import { useGetCitySuggestionsQuery } from '../api/api' // Import the custom query hook

function Search({ setSearch, setCachedLocations, cachedLocations }) {
  const [value, setValue] = useState('')
  const [suggestions, setSuggestions] = useState([])

  const { data: citySuggestions = [] } = useGetCitySuggestionsQuery(value) // Use the custom query hook
