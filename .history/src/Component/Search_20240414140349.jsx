  ...
  return (
    <div className='flex'>
      <input
        ...
        className='rounded p-2 w-60 h-8  bg-slate-200 border border-slate-200 focus:bg-slate-300  focus:border-sky-500 focus:outline-none hover:outline-none hover:duration-300 focus:duration-300 duration-300'
      />
      <button
