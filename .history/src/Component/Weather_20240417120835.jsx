...
function Weather() {
  ...
  return (
    <div className='lg:hidden flex flex-col lg:flex-row justify-between items-center bg-slate-100 w-full min-h-screen lg:w-3/4 lg:h-3/4 rounded-sm shadow p-5'>
      {' '}
